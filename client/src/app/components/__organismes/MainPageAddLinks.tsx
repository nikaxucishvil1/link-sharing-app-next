...
const MainPageAddLinks = (props: Addlinks) => {
  ...
  return (
    <div className="w-full flex items-center justify-start flex-col bg-white lg:bg-[#FAFAFA] rounded-[12px] lg:w-[55%] gap-10 lg:mt-0 lg:pt-0">
      <Formik
        enableReinitialize
          ...
          <Form className="w-full lg:bg-[#FAFAFA]" autoComplete="off">
            <div className=" lg:bg-white lg:p-7 lg:flex lg:items-center lg:flex-col lg:justify-between lg:h-[716px]">
              ...
              <div className="md:flex md:items-center md:justify-end lg:justify-between lg:w-full">
                {width > 1024 && (
                  <p className="mt-6 text-[#737373] font-[400] text-[16px]">
